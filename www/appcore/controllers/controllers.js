        ...
        function(AuthService,$scope,$ionicLoading,$state,$ionicPopup,$timeout){
            ...
            var success = function(response){
                ...
                if(response.data.error==true){
                    ...
                    $scope.successmsg = "Check your mail for your temporary password";
        ...
        var error = function(error){
           // $ionicLoading.hide();
            ...
            var success = function(response){
                ...
                localStorageService.remove('user_transaction');
                localStorageService.set('user_transaction',JSON.stringify(response.data.transactions));
                //console.log($scope.countTransaction);
                getTransById();
...
.controller('VoucherSetupController', ['VoucherSetupService','AuthService','$scope','$state','$ionicLoading',
        '$timeout','$ionicPopup','InternetMonitor','localStorageService','$stateParams',
        ...
        var error = function(error){
            ...
            var success = function(response){
               ...
               // $scope.balances=response.data;
                ...
                $scope.userLevel = $scope.vouchers[0].tierlevel;
...
.controller('WalletController', ['WalletService','AuthService','$scope','$state','$ionicLoading',
    '$timeout','$ionicPopup','localStorageService','$interval','$ionicHistory',
    function(WalletService,AuthService,$scope,$state,$ionicLoading,$timeout,$ionicPopup,localStorageService,$interval,$ionicHistory){
